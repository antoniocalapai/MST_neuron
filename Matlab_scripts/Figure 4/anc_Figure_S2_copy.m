...
database_path ='/Users/chengxue/Dropbox/MST_manuscript/Databases/';
fig_path = '/Users/chengxue/Dropbox/MST_manuscript/Figures/';
...
g(1,1)=gramm('x',data(:,2),'color',monkey);
...
g(2,1)=gramm('x',data(:,2),'y',data(:,1),'color',monkey);
...
g(3,1)=gramm('x',data(:,1),'color',monkey);
