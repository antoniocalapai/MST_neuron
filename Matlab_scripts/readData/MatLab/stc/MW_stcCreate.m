function STCdata = MW_stcCreate(axesHandle,STCname,varargin)
% STCdata = MW_stcCreate_(axesHandle,STCname,axesPropertyList)
%
...
MW_default_STC_propertylist.Title = 'Staircase';
...
STCdata.turningPoints = [];
STCdata.threshold = [];
STCdata.turningPointsX = [];
STCdata.currentDirection = 0;
